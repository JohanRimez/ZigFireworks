...
The Coding Train - Coding challenge #27 - Fireworks
https://thecodingtrain.com/challenges/27-fireworks
...
The main calculation loop is done with thread pool (just as an exercise).
